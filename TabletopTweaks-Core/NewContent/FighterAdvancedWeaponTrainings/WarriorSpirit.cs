...
namespace TabletopTweaks.Core.NewContent.FighterAdvancedWeaponTrainings {
    static class WarriorSpirit {
        public static void AddWarriorSpirit() {
            ...
            var Icon_WarriorSpirit_Axiomatic = AssetLoader.LoadInternal(modContext: TTTContext, folder: "Abilities", file: "Icon_WarriorSpirit_Axiomatic.png");
            var Icon_WarriorSpirit_Bane = AssetLoader.LoadInternal(modContext: TTTContext, folder: "Abilities", file: "Icon_WarriorSpirit_Bane.png");
            var Icon_WarriorSpirit_BrilliantEnergy = AssetLoader.LoadInternal(modContext: TTTContext, folder: "Abilities", file: "Icon_WarriorSpirit_BrilliantEnergy.png");
            var Icon_WarriorSpirit_Corrosive = AssetLoader.LoadInternal(modContext: TTTContext, folder: "Abilities", file: "Icon_WarriorSpirit_Corrosive.png");
            var Icon_WarriorSpirit_CorrosiveBurst = AssetLoader.LoadInternal(modContext: TTTContext, folder: "Abilities", file: "Icon_WarriorSpirit_CorrosiveBurst.png");
            var Icon_WarriorSpirit_Flaming = AssetLoader.LoadInternal(modContext: TTTContext, folder: "Abilities", file: "Icon_WarriorSpirit_Flaming.png");
            ...
            var Icon_WarriorSpirit_Frost = AssetLoader.LoadInternal(modContext: TTTContext, folder: "Abilities", file: "Icon_WarriorSpirit_Frost.png");
            var Icon_WarriorSpirit_GhostTouch = AssetLoader.LoadInternal(modContext: TTTContext, folder: "Abilities", file: "Icon_WarriorSpirit_GhostTouch.png");
            var Icon_WarriorSpirit_Holy = AssetLoader.LoadInternal(modContext: TTTContext, folder: "Abilities", file: "Icon_WarriorSpirit_Holy.png");
            ...
            var Icon_WarriorSpirit_Shock = AssetLoader.LoadInternal(modContext: TTTContext, folder: "Abilities", file: "Icon_WarriorSpirit_Shock.png");
            ...
            var Icon_WarriorSpirit_Thundering = AssetLoader.LoadInternal(modContext: TTTContext, folder: "Abilities", file: "Icon_WarriorSpirit_Thundering.png");
            var Icon_WarriorSpirit_ThunderingBurst = AssetLoader.LoadInternal(modContext: TTTContext, folder: "Abilities", file: "Icon_WarriorSpirit_ThunderingBurst.png");
            var Icon_WarriorSpirit_Speed = AssetLoader.LoadInternal(modContext: TTTContext, folder: "Abilities", file: "Icon_WarriorSpirit_Speed.png");
            var Icon_WarriorSpirit_Unholy = AssetLoader.LoadInternal(modContext: TTTContext, folder: "Abilities", file: "Icon_WarriorSpirit_Unholy.png");
