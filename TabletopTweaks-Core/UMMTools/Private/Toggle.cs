...
namespace TabletopTweaks.Core.UMMTools.Private {
    public static partial class UI {
        ...
        public static readonly GUIContent CheckOn = new(TabletopTweaks.Core.UMMTools.UI.ChecklyphOn);
        public static readonly GUIContent CheckOff = new(TabletopTweaks.Core.UMMTools.UI.CheckGlyphOff);
        public static readonly GUIContent DisclosureOn = new(TabletopTweaks.Core.UMMTools.UI.DisclosureGlyphOn);
        public static readonly GUIContent DisclosureOff = new(TabletopTweaks.Core.UMMTools.UI.DisclosureGlyphOff);
        public static readonly GUIContent DisclosureEmpty = new(TabletopTweaks.Core.UMMTools.UI.DisclosureGlyphEmpty);
