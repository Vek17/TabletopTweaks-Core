...
namespace TabletopTweaks.Core.Bugfixes.Features {
    class Bloodlines {
        ...
        static void PatchBloodlineRestrictions() {
            ...
            // Bloodline Requisite 
            var BloodlineRequisiteFeature = BlueprintTools.GetModBlueprint<BlueprintFeature>(modContext: TTTContext, "BloodlineRequisiteFeature");
            // Requisite Features
            ...
            void FixDragonDisciple() {
                ...
                DragonDiscipleSpellbookSelection.AddFeatures(
                    BlueprintTools.GetModBlueprint<BlueprintFeature>(modContext: TTTContext, "DragonDiscipleSageSorcerer"),
                    BlueprintTools.GetModBlueprint<BlueprintFeature>(modContext: TTTContext, "DragonDiscipleEmpyrealSorcerer"),
                    BlueprintTools.GetModBlueprint<BlueprintFeature>(modContext: TTTContext, "DragonDiscipleUnletteredArcanist"),
                    BlueprintTools.GetModBlueprint<BlueprintFeature>(modContext: TTTContext, "DragonDiscipleNatureMage"),
                    BlueprintTools.GetModBlueprint<BlueprintFeature>(modContext: TTTContext, "DragonDiscipleAccursedWitch")
                ); ;
